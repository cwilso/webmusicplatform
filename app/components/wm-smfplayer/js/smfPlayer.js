...
//            return;
        ...
        if(typeof this.mOut.updateMsgIndicator=="function") {
            var self=this;
            setTimeout( function(){
                self.mOut.updateMsgIndicator(parseInt(msg[0].toString(16).substr(1, 1), 16));
            }, self.latency*2);
        }
...
//            this.mOut.send([fb, 0x78, 0x00], this.startTime+this.eventTime);
